    ...
    internal class Buttons
    {
        public static ButtonInfo[][] buttons = new ButtonInfo[][]
        {
            new ButtonInfo[] { // Main Mods [0]
                ...
                new ButtonInfo { buttonText = "Advantages Mods", method =() => Main.currentCategoryName = "Advantage Mods", isTogglable = false, toolTip = "Opens the movement mods."},
            ...
            new ButtonInfo[] { // Settings [1]
                ...
                new ButtonInfo { buttonText = "Advantage", method =() => SettingsMods.AdvantageSettings(), isTogglable = false, toolTip = "Opens the advantage settings for the menu."},
            },
            ...
            new ButtonInfo[] { // Advantage Settings [4]
                ...
                new ButtonInfo { buttonText = "Change Arm Length", overlapText = "Change Arm Length <color=grey>[</color><color=green>Normal</color><color=grey>]</color>", method =() => Advantages.ChangeArmLength(), isTogglable = false, toolTip = "Changes the length of the long arm mods."},
            },
            new ButtonInfo[] { // Projectile Settings [5]
                
            },

            new ButtonInfo[] { // Movement [6]
                new ButtonInfo { buttonText = "Return to Main", method =() => Global.ReturnHome(), isTogglable = false, toolTip = "Returns to the main page of the menu."},
            ...
            new ButtonInfo[] { // Overpowered [9]
                new ButtonInfo { buttonText = "Return to Main", method =() => Global.ReturnHome(), isTogglable = false, toolTip = "Returns to the main page of the menu."},
                new ButtonInfo { buttonText = "Freeze Server", method=() => Overpowered.FreezeServer(), toolTip = "Freezes the server", isTogglable = true},
                new ButtonInfo { buttonText = "Freeze Rig Gun", method=() => Overpowered.FreezeRigGun(true), toolTip = "Freezes the targets rig on everyones screen.", isTogglable = true},
            },

            new ButtonInfo[] { // Visuals [10]
                new ButtonInfo { buttonText = "Return to Main", method =() => Global.ReturnHome(), isTogglable = false, toolTip = "Returns to the main page of the menu." },
